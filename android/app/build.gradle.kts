...
android {
  ...
  val shellVersion = "0.6.3" // 同步时固化(公开仓没有 monorepo 的 version.json)
...
dependencies {
  // ⬇️ 这一行就是接入所需的全部依赖声明
  implementation("com.aihecong:hecong-chat-sdk:0.6.3")
  ...
  // (也是我们发版前「新版档」测试用的配置;1.16+ 需要 AGP 8.6+,本工程是 8.3.2)。
