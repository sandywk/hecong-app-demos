...
//
// 本地环境:PORT=5177 pnpm demo:link + 本地后端 3024/17108;
// 安卓模拟器先跑:adb reverse tcp:5177 tcp:5177 && adb reverse tcp:3024 tcp:3024 && adb reverse tcp:17108 tcp:17108
...
internal object LocalEnv {
  ...
  val loaderUrlOrNull: String? = "http://localhost:5177/hecong-link.js"
}
